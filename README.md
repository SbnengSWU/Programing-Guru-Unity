...
프로젝트의 Scenes 폴더에 시작 화면, 이름 입력 화면, 기본 조작 설명 화면, 플레이 화면, 게임 클리어 화면, 게임 오버 화면 폴더를 추가해놓았습니다.   
플레이 화면 씬에 Empty Object로 모든 맵의 틀만 추가하였고, Canvas에 Empty Object로 PauseMenu 추가하였습니다. 해당 오브젝트들 아래에 개발해주시면 될 것 같습니다.      
